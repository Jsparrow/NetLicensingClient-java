...
public class NetLicensingClientDemo {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			License license = LicenseService.create(context, licenseeNumber, licenseTemplateNumber, null, newLicense);
			...
			final String filter = new StringBuilder().append(Constants.Token.TOKEN_TYPE).append("=")
					.append(TokenType.SHOP.name()).toString();
			...
			Page<Transaction> transactions = TransactionService.list(context,
					new StringBuilder().append(Constants.Transaction.SOURCE_SHOP_ONLY).append("=")
