 ...
 * <p>
 * The Context object may differ depending on the level at which NetLicensing
 * API is called.
 * <p>
 * For the internal Java NetLicensing API the Context provides information about
 * the targeted Vendor.
 */
