...
public class ValidationParameters {
	 ...
	 * 
	 * @param licenseeName optional human-readable licensee name in case licensee
	 *                     will be auto-created. This parameter must not be the
	 *                     name, but can be used to store any other useful string
	 *                     information with new licensees, up to 1000 characters.
	 */
	 ...
	 * 
	 * @param licenseeSecret licensee secret stored on the client side. Refer to
	 *                       Licensee Secret documentation for details.
	 */
	...
	public Map<String, String> getProductModuleValidationParameters(final String productModuleNumber) {
		getParameters().putIfAbsent(productModuleNumber, new HashMap<>());
