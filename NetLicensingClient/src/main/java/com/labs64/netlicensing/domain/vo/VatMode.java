...
public enum VatMode {
	...
	private static final Logger logger = LoggerFactory.getLogger(VatMode.class);
	private final String value;

	/**
	 * @param vatModeValue vatMode value
	 */
	 ...
	 *
	 * @param value vatMode value
	 * @return {@link VatMode} enum object or throws
	 *         {@link IllegalArgumentException} if no corresponding {@link VatMode}
	 *         enum object found
	 */
