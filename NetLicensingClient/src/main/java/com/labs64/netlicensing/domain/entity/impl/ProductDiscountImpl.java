...
/**
 * Represents discount step as a discount amount (absolute or percentage) after
 * total price reaches the given threshold.
 */
public class ProductDiscountImpl implements ProductDiscount, Serializable {

	private static final Logger logger = LoggerFactory.getLogger(ProductDiscountImpl.class);
	...
	/**
	 * Gets the discount amount as string, with '%' sign at the end indicating
	 * discount is given in percent.
	 *
	...
	public String getStringAmount() {
		...
		if (getAmountPercent() != null) {
			return String.valueOf(getAmountPercent()) + "%";
		}
		return "Error";
	}

	/**
	 * Sets the discount amount from string, '%' sign at the end indicates discount
	 * is provided in percent.
	 *
