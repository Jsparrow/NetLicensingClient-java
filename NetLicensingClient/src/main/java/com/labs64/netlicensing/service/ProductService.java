...
public class ProductService {
	 ...
	 * @param product non-null properties will be taken for the new object, null
	...
	public static Product create(final Context context, final Product product) throws NetLicensingException {
		...
		return NetLicensingService.getInstance().post(context, Constants.Product.ENDPOINT_PATH, product.asRequestForm(),
				Product.class);
	}
	...
	public static Product get(final Context context, final String number) throws NetLicensingException {
		...
		return NetLicensingService.getInstance().get(context,
				new StringBuilder().append(Constants.Product.ENDPOINT_PATH).append("/").append(number).toString(), null,
				Product.class);
	}
	 ...
	 * @param product non-null properties will be updated to the provided values,
	...
	public static Product update(final Context context, final String number, final Product product)
		...
		return NetLicensingService.getInstance().post(context,
				new StringBuilder().append(Constants.Product.ENDPOINT_PATH).append("/").append(number).toString(),
				product.asRequestForm(), Product.class);
	}
