...
public class ProductService {
	...
	public static Product get(final Context context, final String number) throws NetLicensingException {
		...
		return NetLicensingService.getInstance().get(context, Constants.Product.ENDPOINT_PATH + "/" + number, null,
				Product.class);
	}
	...
	public static Product update(final Context context, final String number, final Product product)
		...
		return NetLicensingService.getInstance().post(context, Constants.Product.ENDPOINT_PATH + "/" + number,
