...
public abstract class NetLicensingException extends Exception {
	...
	/**
	 * Construct a <code>NetLicensingException</code> with the specified detail
	 * message.
	 * 
	...
	/**
	 * Return the detail message, including the message from the cause exception if
	 * there is one.
	 * 
	 ...
	 * it is of the given class itself or it contains a cause cause of the given
	 * type.
	 * 
