...
/**
 * The Class RestException can be used in cases where no checked exception can
 * be thrown (e.g. 3pp interfaces implementation).
 */
public class RestException extends NetLicensingException {
	...
	/**
	 * Construct a <code>RestException</code> with the specified detail message and
	 * cause exception.
	 * 
	 * @param msg   the detail message
